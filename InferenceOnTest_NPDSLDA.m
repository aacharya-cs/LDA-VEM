function [testmodel, perfval, probassign] = InferenceOnTest_NPDSLDA(trmodel, data, MAXESTEPITER, option)

%% inference on test data
probassign = [];
testmodel  = inittestmodel_NPDSLDA(trmodel, data, option);
count1     = 0;
maxvalue   = -1e25;
...
while(count1<20)
    ...
    [testmodel.zeta, testmodel.ss_lambda, testmodel.ss_features] = update_zeta(testmodel, data, arg1, arg2, arg3, count1, option);
...
[accval, confmat, probassign, binacc] = cal_accuracy_NPDSLDA(testmodel, data, option);
