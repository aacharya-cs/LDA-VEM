...
% % % % 
% % % % 
% % % % disp('*************** DSLDA-NSLT2 starts ****************'); %% DSLDA-NSLT1 with epsilon = 0;
% % % % %%run labeled LDA with class labels (with the same training and test data)
% % % % [trmodelDSLDANSLT2, trperfDSLDANSLT2] = variational_EM(trdata, MAXCOUNT, MAXESTEPITER, MAXMSTEPITER, MaxFun, p, [], 8, 1, []);
% % % % if(troption==1)  %% test on training data
% % % %    testdata = trdata;
% % % % end
% % % % [testmodelDSLDANSLT2, testperfDSLDANSLT2] = InferenceOnTest(trmodelDSLDANSLT2, testdata, MAXESTEPITER, 8, p);
% % % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % 
...
% % A;
% % 
% % B = [MCMacc*100 svmacc*100 testperfNPDSLDA.multiclassacc]; % testperfmedLDAova{1}.multiclassaccuracy*100]; 
